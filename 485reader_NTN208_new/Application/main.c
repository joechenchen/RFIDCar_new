...
uint8_t ucCycRFID;
uint8_t rx_US = 0;//³¬Éù²¨±êÇ©×´Ì¬0ÇĞ»»£¬ÎŞ³µÊ±£¬×´Ì¬0£¬ÓĞ³µÊ±£¬×´Ì¬1

#define ID_BEGIN 0X3D000
...
//	uint8_t *temp_buf;
	...
	nrf_nvmc_read_bytes(ID_BEGIN,caucID,4);//[0]¶ÔÓ¦¸ß×Ö½Ú
